...
// Collage-Raster (grid-column / grid-row / Drift) — 1:1 aus dem Claude-Design (Startseite 02, exakt 4 Kacheln).
const SPANS = [
  { col: '1 / span 7', row: 'span 5', drift: 10 },
  { col: '8 / span 5', row: 'span 5', drift: -16 },
  { col: '1 / span 5', row: 'span 4', drift: 14 },
  { col: '6 / span 7', row: 'span 4', drift: -8 },
];
